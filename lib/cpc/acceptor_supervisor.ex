defmodule Cpc.AcceptorSupervisor do
  ...
  def start_link(listening_sock, arch, purger_name) do
    ...
    args = {listening_sock, sup_pid, purger_name}
  ...
  def handle_info(:init, {listening_sock, sup_pid, purger_name}) do
    accept(listening_sock, sup_pid, purger_name)
    {:noreply, nil}
  end

  def accept(listening_sock, sup_pid, purger_name) do
    ...
    {:ok, child_pid} = Supervisor.start_child(sup_pid, [accepting_sock, purger_name])
